...
class EnvSettings:
    def __init__(self):
        pydoctor_path= os.path.abspath(os.path.join(os.path.dirname(__file__), '..'))

        self.results_path = '{}/diagnose_results/'.format(pydoctor_path)
        self.network_path = '{}/networks/'.format(pydoctor_path)
        self.lumbar_path = '{}/result_plots/'.format(pydoctor_path)
...
def create_default_local_file():
    ...
    with open(path, 'w') as f:
        ...
        f.write('from pydoctor.evaluation.environment import EnvSettings\n\n')
...
def env_settings():
    env_module_name = 'pydoctor.evaluation.local'
    try:
