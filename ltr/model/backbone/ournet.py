...
class OurNet(Backbone):
    ...
    def __init__(self, block, layers, output_layers, num_classes=1000, inplanes=64, dilation_factor=1, frozen_layers=()):
        ...
        super(OurNet, self).__init__(frozen_layers=frozen_layers)
        self.output_layers = output_layers
        self.conv1 = nn.Conv2d(5, inplanes, kernel_size=7, stride=2, padding=3,
                               bias=False)
...
def ournet_baby(output_layers=None, pretrained=False, inplanes=16, **kwargs):
    ...
    model = OurNet(BasicBlock, [2, 2, 2, 2], output_layers, inplanes=inplanes, **kwargs)
...
def ournet18(output_layers=None, pretrained=False, **kwargs):
    """Constructs a ResNet-18 model.
    """
    ...
    model = OurNet(BasicBlock, [2, 2, 2, 2], output_layers, **kwargs)
...
def ournet50(output_layers=None, pretrained=False, **kwargs):
    ...
    model = OurNet(Bottleneck, [3, 4, 6, 3], output_layers, **kwargs)
    if pretrained:
